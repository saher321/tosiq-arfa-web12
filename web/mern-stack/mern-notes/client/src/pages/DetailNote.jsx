...
import { NOTE } from "../resources/api";
        ...
        <div className="max-w-xl rounded bg-white/70 p-3">
          <form onSubmit={handleSubmit(handleSaveNote)}>
            <div>
              ...
              <input {...reset("title")} className='w-full rounded p-3 shadow' placeholder='Enter title' />
            </div>
            <div className='my-3'>
              <label className='block'>Description</label>
              <textarea {...reset("description")} className='w-full rounded p-3 shadow' placeholder='Enter description'></textarea>
            </div>
            <div>
              {isLoading ?
